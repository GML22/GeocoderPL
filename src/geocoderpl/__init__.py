...
def main() -> None:
    ...
    # Sprawdzamy w bazie czy istnieje tablica 'BDOT10K_TABLE', jezeli tak to idziemy dalej jezeli nie to ja tworzymy
    if not insp.has_table('BDOT10K_TABLE'):
        # Tworzymy tabelę 'BDOT10K_TABLE' z danymi o budynkach
        create_bdot10k_table(sql_engine)

    # Sprawdzamy w bazie czy istnieje tablica 'PRG_TABLE', jezeli tak to idziemy dalej jezeli nie to ja tworzymy
